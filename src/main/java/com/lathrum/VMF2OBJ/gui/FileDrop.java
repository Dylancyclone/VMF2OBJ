...
public class FileDrop {
	 ...
	 * @since 1.0
	 */
	public FileDrop(final Component c, final boolean recursive, final Consumer<File[]> listener) {
		this(null, // Logging stream
				c, // Drop target
				BorderFactory.createMatteBorder(2, 2, 2, 2, defaultBorderColor), // Drag border
				recursive, // Recursive
	 ...
	 * @since 1.0
	 */
	public FileDrop(final PrintStream out, final Component c, final Consumer<File[]> listener) {
	 ...
	 * @since 1.0
	 */
	public FileDrop(final PrintStream out, final Component c, final boolean recursive, final Consumer<File[]> listener) {
		this(out, // Logging stream
				c, // Drop target
				BorderFactory.createMatteBorder(2, 2, 2, 2, defaultBorderColor), // Drag border
				recursive, // Recursive
	 ...
	 * @since 1.0
	 */
	public FileDrop(final Component c, final Border dragBorder, final Consumer<File[]> listener) {
		this(null, // Logging stream
				c, // Drop target
	 ...
	 * @since 1.0
	 */
	public FileDrop(final PrintStream out, final Component c, final Border dragBorder, final Consumer<File[]> listener) {
		this(out, // Logging stream
				c, // Drop target
				dragBorder, // Drag border
				false, // Recursive
